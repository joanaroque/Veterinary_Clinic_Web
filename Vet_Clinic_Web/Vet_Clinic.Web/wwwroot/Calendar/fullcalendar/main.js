...
!function (e, t) {
                ...
                for (var p in s) {
                    ...
                    for (var b = t.state.eventStore, D = 0, T = g.allows; D < T.length; D++) {
                        var w = T[D]
                            ...
                            , I = b.instances[p]
                            , M = void 0;
                        if (M = C ? new ct(t, C, I) : new ct(t, y),
    ...
    function Zt(e, t, n, r) {
        ...
        if (a)
            return (s = jt(o, t, a.allDay, Boolean(a.duration), n)).recurringDef = {
                typeId: a.typeId,
                typeData: a.typeData,
                duration: a.duration
            },
        ...
        , rn = function (e) {
            ...
            return Ee(t, e),
                ...
                t.prototype.off = function (e, t) {
                    return this._handlers && an(this._handlers, e, t),
                    ...
                    if (e.split(",").forEach((function (e, t) {
                        ...
                        "title" === e ? (o.push(i("<h2>&nbsp;</h2>")),
                            l = !1) : ((r = f[e]) ? (d = function (e) {
                                ...
                                ,
                                (v = a.getCustomButtonIconClass(r)) || (v = a.getIconClass(e)) || (g = r.text)) : (s = c[e]) ? (n.viewsWithButtons.push(e),
                                    d = function () {
                                        u.changeView(e)
                                    }
                                    ,
                                ...
                                d && (m = ["fc-" + e + "-button", a.getClass("button")],
                                    g ? (y = Pt(g),
            ...
            return Ee(t, e),
                ...
                t.prototype._renderSkeleton = function (e) {
                    this.updateElClassNames(e),
                        u(this.el, this.contentEl = r("div", {
                ...
                t.prototype._renderToolbars = function (e, t, n, r) {
                    ...
                    d ? (o || (o = this.header = new gr("fc-header-toolbar"),
                        u(this.el, o.el)),
                        o.receiveProps(Se({
                            layout: d
                        }, m), i)) : o && (o.destroy(),
                            o = this.header = null),
                        f ? (a || (a = this.footer = new gr("fc-footer-toolbar"),
                            s(this.el, a.el)),
                            a.receiveProps(Se({
                                layout: f
                            }, m), i)) : a && (a.destroy(),
                ...
                t.prototype.queryToolbarsHeight = function () {
                    var e = 0;
                    return this.header && (e += C(this.header.el)),
        ...
        , Tr = function (e) {
            function t(t) {
                ...
                n.handleSegClick = function (e, t) {
                    ...
                    ;
                var r = t.component;
                return n.destroy = _(r.el, "click", r.fgSegSelector + "," + r.bgSegSelector, n.handleSegClick),
                    n
            }
            return Ee(t, e),
                t
    ...
    var Cr = function () {
        ...
        return e.prototype.addPluginInputs = function (e) {
            ...
            e.prototype.render = function () {
                this.component ? this.requestRerender() : (this.component = new yr(this.el),
    ...
    var xr = function (e) {
        ...
        return Ee(t, e),
            ...
            t.prototype.startNowIndicator = function (e, t) {
                ...
                a.options.nowIndicator && !this.initialNowDate && (n = this.getNowIndicatorUnit(e, t)) && (r = this.updateNowIndicator.bind(this),
    ...
    function Wr(e, t, n, r, i, o, a, s) {
        var u, l = o.dateEnv, c = o.theme, d = o.options, f = Ze(t.activeRange, e), p = ["fc-day-header", c.getClass("widgetHeader")];
        return u = "function" == typeof d.columnHeaderHtml ? d.columnHeaderHtml(l.toDate(e)) : "function" == typeof d.columnHeaderText ? Pt(d.columnHeaderText(l.toDate(e))) : Pt(l.format(e, i)),
            n ? p = p.concat(en(e, t, o, !0)) : p.push("fc-" + P[e.getUTCDay()]),
            '<th class="' + p.join(" ") + '"' + (f && n ? ' data-date="' + l.formatIso(e, {
                omitTime: !0
